...
public class Objects07 {
     ...
     */
    public static final boolean isValid(RSObject object, boolean reach) {
        if (reach) {
     ...
     */
    public static final RSObject getObject(final int id, final int dist) {
        RSObject[] objs = Objects.find(dist, id);
        Sorting.sortByDistance(objs, Player.getPosition(), true);
        return objs.length > 0 ? objs[0] : null;
    }
    
    public static final boolean waitMoveCondition(Condition c, long timeout) {
     ...
     * @return The nearest object. Null if no objects were found.
     */
    public static final RSObject getObject(String name, int distance) {
        if (name == null) {
            return null;
        }
     ...
     * @return The nearest object. Null if no objects were found.
     */
    public static final RSObject getObject(Filter<RSObject> filter, int distance) {
        if (filter == null) {
            return null;
        }
     ...
     */
    public static final RSObject getObjectAt(RSTile tile) {
        if (tile == null) {
            return null;
        }
     ...
     * @return The first object. Null if no objects were found.
     */
    public static final RSObject getObjectAt(RSTile tile, String... names) {
     ...
     */
    public static final RSObject getObjectAt(RSTile tile, String[] names, String[] options) {
     ...
     */
    public static final RSObject getObjectIn(final String name, final RSArea area) {
